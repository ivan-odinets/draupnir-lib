...
#ifndef ABSTRACTMESSAGECATEGORYREGISTRY_H
#define ABSTRACTMESSAGECATEGORYREGISTRY_H
...
/*! @class AbstractMessageCategoryRegistry
 *  @ingroup Logging */

class AbstractMessageCategoryRegistry : public MessageCategoriesSerializerInterface
{
public:
    virtual bool contains(MessageCategory id) const = 0;
