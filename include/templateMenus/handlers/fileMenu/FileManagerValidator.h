...
///@{
    ...
    /*! @brief Checks for openFile(const QString&) and openFile(const QFileInfo&) methods, both returning void.
     * @todo Maybe only one method will be enough ? */
    template<class, class = std::void_t<>>
...
///@{
     ...
     * @todo Separate this into seperate thing. */
    template<class, class = std::void_t<>>
