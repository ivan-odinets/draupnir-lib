...
/*! @class DefaultMessageCategoryTrait draupnir/messages/traits/categories/DefaultMessageCategoryTrait.h
 *  @ingroup Messages
 *  @brief Trait describing the default message category.
 *
 *  @details Provides compile-time metadata for the default message category, including its identifier, configuration key,
 *           and translatable display name. */
