...
/*! @class MessageGroup draupnir/message_system/core/MessageGroup.h
 *  @brief Represents a logical group of related log messages.
 *
 *  @details This class is a lightweight wrapper around an integer ID, used to group related log messages together.
 *           @ref Draupnir::Messages::Message objects which are assigned to specific group are immediately shown in
 *           the @ref Draupnir::Messages::MessageListModel when logged via the Logger. Displaying the actual
 *           notification (system tray or message box) is postponed until this group is flushed or ended.
 *
 ...
 *
 * @see @ref Draupnir::Messages::AbstractMessageHandler, @ref Draupnir::Messages::MessageHandlerTemplate). */
