 ...
 *
 * @todo This class can be refractored (together with MessageUiBuilderTemplate) in order to "standartize" behaviour of
 *       methods: should all of them return ready to use witgets or not? Maybe the best way will be to split something
 *       like WidgetFactory out from this thingy and do the following: UiBuilder - returns ready-to-use-stuff. Factory
 *       - creates. */
