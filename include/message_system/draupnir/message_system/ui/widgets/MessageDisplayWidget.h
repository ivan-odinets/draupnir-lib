...
namespace Draupnir::Messages { class Message; }

namespace Draupnir::Messages
{

/*! @class MessageDisplayWidget draupnir/message_system/ui/widgets/MessageDisplayWidget.h
...
public:
    ...
    /*! @brief Show @ref Draupnir::Messages::Message object within this widget.
     *  @param message - pointer to the Draupnir::Messages::Message object. Can not be nullptr. */
