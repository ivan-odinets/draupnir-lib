...
#include "draupnir/utils/CheckableUiElementHelper.h"

namespace Draupnir::Messages
{

/*! @class MessageFieldsSelectorBase draupnir/core/MessageFieldsSelectorBase.h
...
public:
        ...
        w_showAllUiElement{nullptr}
    {
        ...
        // All Action
        w_showAllUiElement = CheckableUiElementHelper<UiElement>::createConnectedUiElement([this](bool isChecked){
