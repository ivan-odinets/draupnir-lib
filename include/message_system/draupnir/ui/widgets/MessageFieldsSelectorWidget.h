...
/*! @class MessageFieldsSelectorWidget draupnir/ui/widgets/MessageFieldsSelectorWidget.h
 *  @ingroup MessageSystem
 *  @brief Widget for selecting which parts of a @ref Draupnir::Messages::Message should be displayed.
 *
 *  @details This widget provides a group of checkboxes (QCheckBox) allowing the user to enable or disable the visibility
 *           of individual @ref Draupnir::Messages::Message::Fields within the @ref Draupnir::Messages::MessageListView
 *           component.
 *
 *           The widget internally uses a template-based helper class, @ref Draupnir::Messages::MessageFieldsSelectorBase,
 *           to manage state, callbacks and logic.
 *
