...
struct extract_settings { using type = Settings::SettingsBundle<>; };
...
struct bundle_push_unique<Settings::SettingsBundle<Ts...>, T> {
    using type = std::conditional_t<
        (std::is_same_v<T, Ts> || ...),
        Settings::SettingsBundle<Ts...>,
        Settings::SettingsBundle<Ts..., T>
    >;
};
...
struct bundle_merge_unique<Settings::SettingsBundle<Ts...>, Settings::SettingsBundle<Us...>> {
    using type = typename bundle_push_all_unique<Settings::SettingsBundle<Ts...>, Us...>::type;
};
...
template<>
struct bundle_merge_all<> { using type = Settings::SettingsBundle<>; };
