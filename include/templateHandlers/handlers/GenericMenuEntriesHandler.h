...
/*! @class GenericMenuEntriesHandler draupnir-lib/include/templateHandlers/handlers/GenericMenuEntriesHandler.h
 ...
 *
 *  @see GenericMenuEntryHandler, Settings::collect_settings_t */

template<class Implementation, class... HandledEntries>
class GenericMenuEntriesHandler
{
public:
    using SettingBundleClass = Settings::collect_settings_t<GenericMenuEntryHandler<Implementation,HandledEntries>...>;
    ...
    template<class SettingsRegistry, class Dummy = SettingBundleClass>
    std::enable_if_t<!Dummy::isEmpty(), void> loadSettings(SettingsRegistry* registry) {
        m_settings = registry->template getSettingsBundle<SettingBundleClass>();
    ...
    template<class SettingTrait, class Dummy = SettingBundleClass>
    std::enable_if_t<!Dummy::isEmpty(), const typename SettingTrait::Value&> getSetting() const {
        static_assert(SettingBundleClass::template contains<SettingTrait>(),
