 ...
 *
 * @note This is a common pattern in C++ template metaprogramming to enforce explicit specialization and provide clear
 *       diagnostics for missing handler implementations. */
