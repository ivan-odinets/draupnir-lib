 ...
 *  @ingroup TestHelpers
 *  @brief This is a mock class implementing @ref Draupnir::Settings::SettingsBackendInterface interface. This class initializes
...
class SettingsBackendMockTemplate final : public Draupnir::Settings::SettingsBackendInterface
{
public:
    ~SettingsBackendMockTemplate() final = default;
...
#endif // SETTINGSBACKENDMOCKTEMPLATE_H
