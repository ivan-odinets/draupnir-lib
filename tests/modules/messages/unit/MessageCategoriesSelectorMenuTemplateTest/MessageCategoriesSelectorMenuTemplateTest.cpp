...
#include "draupnir/messages/ui/menus/MessageCategoriesSelectorMenuTemplate.h"

using namespace Draupnir::Messages;

/*! @class MessageCategoriesSelectorMenuTemplateTest tests/modules/messages/unit/MessageCategoriesSelectorMenuTemplateTest.cpp
 *  @ingroup MessagesTests
 *  @brief Unit test for the @ref Draupnir::Messages::MessageCategoriesSelectorMenuTemplate class. */
