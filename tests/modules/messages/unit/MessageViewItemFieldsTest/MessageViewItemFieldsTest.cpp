...
/*! @class MessageViewItemFieldsTest tests/modules/messages/unit/MessageViewItemFieldsTest.cpp
 *  @ingroup MessagesTests
 *  @brief Unit test for @ref Draupnir::Messages::MessageViewItemFields class. */
