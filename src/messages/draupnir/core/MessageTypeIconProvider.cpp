...
const QIcon& MessageTypeIconProvider::getIcon(const MessageType& messageType) const
{
...
const QIcon& MessageTypeIconProvider::_noIcon()
{
    static QIcon empty;
    return empty;
}

const QIcon& MessageTypeIconProvider::_defaultDebugIcon() {
    return _noIcon();
}

const QIcon& MessageTypeIconProvider::_defaultInfoIcon() {
    static QIcon icon{qApp->style()->standardIcon(QStyle::SP_MessageBoxInformation)};
    return icon;
}

const QIcon& MessageTypeIconProvider::_defaultWarningIcon()
{
    static QIcon icon{qApp->style()->standardIcon(QStyle::SP_MessageBoxWarning)};
    return icon;
}

const QIcon& MessageTypeIconProvider::_defaultErrorIcon()
{
